				...
				<div className={style.my_application_table_container}>
					...
					>
						...
						{coursesData.map(data => (
							...
							>
								<td className={style.my_application_table_content_course_title}>
									<p>{data.title}</p>
								</td>
								...
								<td className={style.my_application_table_content_course_type}>
									<p>{data.course_type}</p>
								</td>
								<td
									className={style.my_application_table_content_course_category}
								>
