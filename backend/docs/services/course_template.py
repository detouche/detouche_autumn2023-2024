...
async def create_course_template(document: CourseTemplateSchema) -> CourseTemplateSchema:
...
async def update_course_template(document: CourseTemplateIDSchema) -> CourseTemplateIDSchema:
...
async def get_all_course_template() -> List[CourseTemplateIDSchema]:
...
async def get_course_template(template_id: int) -> CourseTemplateIDSchema:
